...
{
    public class CreateResellerCommandValidatorTests
    {
        private readonly Mock<IValidationService> _validationServiceMock;
        private readonly CreateResellerCommandValidator _validator;

        public CreateResellerCommandValidatorTests()
        {
            _validationServiceMock = new Mock<IValidationService>();
            _validator = new CreateResellerCommandValidator(_validationServiceMock.Object);
        }
        ...
        private CreateResellerCommand CreateValidCommand()
        {
